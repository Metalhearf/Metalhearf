...
| --- | --- | --- | --- |
| [`ruvnet/RuView`](https://github.com/ruvnet/RuView) | ⭐69.6k | 🔥 | π RuView turns commodity WiFi signals into real-time spatial intelligence, vital sign monitoring, and prese... |
| [`KeygraphHQ/shannon`](https://github.com/KeygraphHQ/shannon) | ⭐44.1k | 🔥 | Shannon Lite is an autonomous, white-box AI pentester for web applications and APIs. It analyzes your sourc... |
| [`trufflesecurity/trufflehog`](https://github.com/trufflesecurity/trufflehog) | ⭐26.6k | 🔥 | Find, verify, and analyze leaked credentials |
| [`usestrix/strix`](https://github.com/usestrix/strix) | ⭐25.7k | 🔥 | Open-source AI hackers to find and fix your app’s vulnerabilities. |
| [`maurosoria/dirsearch`](https://github.com/maurosoria/dirsearch) | ⭐14.3k | 🔥 | Web path scanner |
| [`AzeemIdrisi/PhoneSploit-Pro`](https://github.com/AzeemIdrisi/PhoneSploit-Pro) | ⭐5.9k | 🔥 | An all-in-one hacking tool to remotely exploit Android devices using ADB and Metasploit-Framework to get a ... |
| [`massgravel/Microsoft-Activation-Scripts`](https://github.com/massgravel/Microsoft-Activation-Scripts) | ⭐177.0k |  | Open-source Windows and Office activator featuring HWID, Ohook, TSforge, and Online KMS activation methods,... |
| [`hashcat/hashcat`](https://github.com/hashcat/hashcat) | ⭐26.1k |  | World's fastest and most advanced password recovery utility |
| [`ffuf/ffuf`](https://github.com/ffuf/ffuf) | ⭐16.2k |  | Fast web fuzzer written in Go |
| [`CISOfy/lynis`](https://github.com/CISOfy/lynis) | ⭐15.7k |  | Lynis - Security auditing tool for Linux, macOS, and UNIX-based systems. Assists with compliance testing (H... |
...
| [`six2dez/reconftw`](https://github.com/six2dez/reconftw) | ⭐7.7k |  | reconFTW is a tool designed to perform automated recon on a target domain by running the best set of tools ... |
| [`jonasstrehle/supercookie`](https://github.com/jonasstrehle/supercookie) | ⭐7.1k |  | ⚠️ Browser fingerprinting via favicon! |
| [`EmenstaNougat/ESP32-BlueJammer`](https://github.com/EmenstaNougat/ESP32-BlueJammer) | ⭐6.3k |  | The ESP32-BlueJammer (Bluetooth jammer, BLE jammer, WiFi jammer, RC jammer) disrupts 2.4GHz communications.... |
| [`infinition/Bjorn`](https://github.com/infinition/Bjorn) | ⭐6.0k |  | Bjorn is a powerful network scanning and offensive security tool for the Raspberry Pi with a 2.13-inch e-Pa... |
| [`V4bel/dirtyfrag`](https://github.com/V4bel/dirtyfrag) | ⭐4.8k |  | _(no description)_ |
...
| [`santoru/shcheck`](https://github.com/santoru/shcheck) | ⭐834 |  | A basic tool to check security headers of a website |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`n8n-io/n8n`](https://github.com/n8n-io/n8n) | ⭐190.5k | 🔥 | Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom cod... |
| [`excalidraw/excalidraw`](https://github.com/excalidraw/excalidraw) | ⭐124.4k | 🔥 | Virtual whiteboard for sketching hand-drawn like diagrams |
| [`Stirling-Tools/Stirling-PDF`](https://github.com/Stirling-Tools/Stirling-PDF) | ⭐80.0k | 🔥 | #1 PDF Application on GitHub that lets you edit PDFs on any device anywhere |
| [`toeverything/AFFiNE`](https://github.com/toeverything/AFFiNE) | ⭐69.0k | 🔥 | There can be more than Notion and Miro. AFFiNE(pronounced [ə‘fain]) is a next-gen knowledge base that bring... |
| [`calcom/cal.diy`](https://github.com/calcom/cal.diy) | ⭐44.9k | 🔥 | Scheduling infrastructure for absolutely everyone. |
| [`siyuan-note/siyuan`](https://github.com/siyuan-note/siyuan) | ⭐44.2k | 🔥 | A privacy-first, self-hosted, fully open source personal knowledge management software, written in typescri... |
| [`logseq/logseq`](https://github.com/logseq/logseq) | ⭐43.2k | 🔥 | A privacy-first, open-source platform for knowledge management and collaboration. Download link:  http://gi... |
| [`paperless-ngx/paperless-ngx`](https://github.com/paperless-ngx/paperless-ngx) | ⭐41.8k | 🔥 | A community-supported supercharged document management system: scan, index and archive all your documents |
| [`glanceapp/glance`](https://github.com/glanceapp/glance) | ⭐34.7k | 🔥 | A self-hosted dashboard that puts all your feeds in one place |
| [`gethomepage/homepage`](https://github.com/gethomepage/homepage) | ⭐30.4k | 🔥 | A highly customizable homepage (or startpage / application dashboard) with Docker and service API integrati... |
| [`sipeed/picoclaw`](https://github.com/sipeed/picoclaw) | ⭐29.2k | 🔥 | Tiny, Fast, and Deployable anywhere — automate the mundane, unleash your creativity |
| [`janeczku/calibre-web`](https://github.com/janeczku/calibre-web) | ⭐17.2k | 🔥 | :books: Web app for browsing, reading and downloading eBooks stored in a Calibre database |
| [`streetwriters/notesnook`](https://github.com/streetwriters/notesnook) | ⭐14.1k | 🔥 | A fully open source & end-to-end encrypted note taking alternative to Evernote. |
| [`alam00000/bentopdf`](https://github.com/alam00000/bentopdf) | ⭐13.5k | 🔥 | The Privacy First PDF Toolkit |
| [`mealie-recipes/mealie`](https://github.com/mealie-recipes/mealie) | ⭐12.3k | 🔥 | Mealie is a self hosted recipe manager and meal planner with a RestAPI backend and a reactive frontend appl... |
| [`Vinzent03/obsidian-git`](https://github.com/Vinzent03/obsidian-git) | ⭐11.1k | 🔥 | Integrate Git version control with automatic commit-and-sync and other advanced features in Obsidian.md |
| [`TandoorRecipes/recipes`](https://github.com/TandoorRecipes/recipes) | ⭐8.4k | 🔥 | Application for managing recipes, planning meals, building shopping lists and much much more! |
| [`clusterzx/paperless-ai`](https://github.com/clusterzx/paperless-ai) | ⭐5.7k | 🔥 | An automated document analyzer for Paperless-ngx using OpenAI API, Ollama, Deepseek-r1, Azure and all OpenA... |
| [`zensical/zensical`](https://github.com/zensical/zensical) | ⭐4.8k | 🔥 | A modern static site generator by the Material for MkDocs team |
...
| [`squidfunk/mkdocs-material`](https://github.com/squidfunk/mkdocs-material) | ⭐26.8k |  | Documentation that simply works |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`ohmyzsh/ohmyzsh`](https://github.com/ohmyzsh/ohmyzsh) | ⭐187.5k | 🔥 | 🙃   A delightful community-driven (with 2,500+ contributors) framework for managing your zsh configuration.... |
| [`be5invis/Iosevka`](https://github.com/be5invis/Iosevka) | ⭐22.3k | 🔥 | Versatile typeface for code, from code. |
| [`davatorium/rofi`](https://github.com/davatorium/rofi) | ⭐16.1k | 🔥 | Rofi: A window switcher, application launcher and dmenu replacement |
| [`HyDE-Project/HyDE`](https://github.com/HyDE-Project/HyDE) | ⭐9.1k | 🔥 | HyDE, your Development Environment 🖥️💻 |
...
| [`catppuccin/vscode-icons`](https://github.com/catppuccin/vscode-icons) | ⭐983 | 🔥 | 🦊 Soothing pastel icons for VSCode/VSCodium |
| [`rubiin/tsumiki`](https://github.com/rubiin/tsumiki) | ⭐234 | 🔥 | modular panel written on fabric |
| [`romkatv/powerlevel10k`](https://github.com/romkatv/powerlevel10k) | ⭐54.3k |  | A Zsh theme |
| [`zsh-users/zsh-syntax-highlighting`](https://github.com/zsh-users/zsh-syntax-highlighting) | ⭐22.7k |  | Fish shell like syntax highlighting for Zsh. |
...
| [`Keyitdev/sddm-astronaut-theme`](https://github.com/Keyitdev/sddm-astronaut-theme) | ⭐2.9k |  | Series of modern looking themes for SDDM. |
...
| [`SleepyCatHey/CozyPixels`](https://github.com/SleepyCatHey/CozyPixels) | ⭐1.2k |  | 🎨 Aesthetic wallpaper collection gathered over a year! Catppuccin, Nord, One Dark themes & cozy vibes. Free... |
| [`Stunkymonkey/nautilus-open-any-terminal`](https://github.com/Stunkymonkey/nautilus-open-any-terminal) | ⭐942 |  | _(no description)_ |
| [`catppuccin/cursors`](https://github.com/catppuccin/cursors) | ⭐721 |  | 🐁 Soothing pastel cursors for GTK/Plasma/Hyprland |
...
| [`zhichaoh/catppuccin-wallpapers`](https://github.com/zhichaoh/catppuccin-wallpapers) | ⭐859 | 💤 | 🖼️ Wallpapers to match your Catppuccin setups! |
| [`nickclyde/rofi-bluetooth`](https://github.com/nickclyde/rofi-bluetooth) | ⭐603 | 💤 | 🔷 A script that generates a rofi menu that uses bluetoothctl to connect to bluetooth devices and display st... |
| [`EliverLara/Sweet-folders`](https://github.com/EliverLara/Sweet-folders) | ⭐246 | 💤 | _(no description)_ |
| [`nordtheme/terminator`](https://github.com/nordtheme/terminator) | ⭐114 | 💤 | An arctic, north-bluish clean and elegant Terminator color theme. |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`fatedier/frp`](https://github.com/fatedier/frp) | ⭐107.0k | 🔥 | A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet. |
| [`dockur/windows`](https://github.com/dockur/windows) | ⭐51.6k | 🔥 | Windows inside a Docker container. |
| [`Dokploy/dokploy`](https://github.com/Dokploy/dokploy) | ⭐34.4k | 🔥 | Open Source Alternative to Vercel, Netlify and Heroku. |
| [`goharbor/harbor`](https://github.com/goharbor/harbor) | ⭐28.6k | 🔥 | An open source trusted cloud native registry project that stores, signs, and scans content. |
...
| [`semaphoreui/semaphore`](https://github.com/semaphoreui/semaphore) | ⭐13.7k | 🔥 | Modern UI and powerful API for Ansible, Terraform/OpenTofu/Terragrunt, PowerShell and other DevOps tools. |
...
| [`nicholas-fedor/watchtower`](https://github.com/nicholas-fedor/watchtower) | ⭐3.7k | 🔥 | Automate Docker container image updates |
| [`Mafyuh/iac`](https://github.com/Mafyuh/iac) | ⭐482 | 🔥 | GitOps-driven Infrastructure as Code for my homelab |
| [`getumbrel/umbrel`](https://github.com/getumbrel/umbrel) | ⭐11.3k |  | An elegant home server OS. Run OpenClaw, store your files and photos, run a Bitcoin node, and do more with ... |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`TryGhost/Ghost`](https://github.com/TryGhost/Ghost) | ⭐53.8k | 🔥 | Independent technology for modern publishing, memberships, subscriptions and newsletters. |
| [`mastodon/mastodon`](https://github.com/mastodon/mastodon) | ⭐50.0k | 🔥 | Your self-hosted, globally interconnected microblogging community |
| [`gitroomhq/postiz-app`](https://github.com/gitroomhq/postiz-app) | ⭐31.3k | 🔥 | 📨 The ultimate agentic social media scheduling tool 🤖 |
| [`chatwoot/chatwoot`](https://github.com/chatwoot/chatwoot) | ⭐29.9k | 🔥 | Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Se... |
| [`docker-mailserver/docker-mailserver`](https://github.com/docker-mailserver/docker-mailserver) | ⭐18.3k | 🔥 | Production-ready fullstack but simple mail server (SMTP, IMAP, LDAP, Antispam, Antivirus, etc.) running ins... |
| [`Vendicated/Vencord`](https://github.com/Vendicated/Vencord) | ⭐13.4k | 🔥 | The cutest Discord modification |
| [`Mail-0/Zero`](https://github.com/Mail-0/Zero) | ⭐10.6k | 🔥 | Experience email the way you want with Mail0 – the first open source email app that puts your privacy and s... |
| [`Mailu/Mailu`](https://github.com/Mailu/Mailu) | ⭐7.3k | 🔥 | Insular email distribution - mail server as Docker images |
...
| [`Legcord/Legcord`](https://github.com/Legcord/Legcord) | ⭐3.3k | 🔥 | Legcord is a custom client designed to enhance your Discord experience while keeping everything lightweight. |
...
| [`processone/fluux-messenger`](https://github.com/processone/fluux-messenger) | ⭐352 | 🔥 | Fluux Messenger: A fast, modern, cross-platform XMPP client for communities and organizations. |
| [`fluxerapp/fluxer`](https://github.com/fluxerapp/fluxer) | ⭐8.7k |  | A free and open source instant messaging and VoIP platform built for friends, groups, and communities. Self... |
| [`Vencord/Vesktop`](https://github.com/Vencord/Vesktop) | ⭐8.0k |  | Vesktop is a custom Discord App aiming to give you better performance and improve linux support |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`awesome-selfhosted/awesome-selfhosted`](https://github.com/awesome-selfhosted/awesome-selfhosted) | ⭐296.6k | 🔥 | A list of Free Software network services and web applications which can be hosted on your own servers |
| [`danielmiessler/SecLists`](https://github.com/danielmiessler/SecLists) | ⭐71.3k | 🔥 | SecLists is the security tester's companion. It's a collection of multiple types of lists used during secur... |
| [`qazbnm456/awesome-web-security`](https://github.com/qazbnm456/awesome-web-security) | ⭐13.4k | 🔥 | 🐶 A curated list of Web Security materials and resources. |
...
| [`codecrafters-io/build-your-own-x`](https://github.com/codecrafters-io/build-your-own-x) | ⭐509.7k |  | Master programming by recreating your favorite technologies from scratch. |
| [`donnemartin/system-design-primer`](https://github.com/donnemartin/system-design-primer) | ⭐351.2k |  | Learn how to design large-scale systems. Prep for the system design interview.  Includes Anki flashcards. |
| [`jwasham/coding-interview-university`](https://github.com/jwasham/coding-interview-university) | ⭐348.0k |  | A complete computer science study plan to become a software engineer. |
| [`twitter/the-algorithm`](https://github.com/twitter/the-algorithm) | ⭐73.4k |  | Source code for the X Recommendation Algorithm |
| [`imthenachoman/How-To-Secure-A-Linux-Server`](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) | ⭐27.7k |  | An evolving how-to guide for securing a Linux server. |
| [`sbilly/awesome-security`](https://github.com/sbilly/awesome-security) | ⭐14.4k |  | A collection of awesome software, libraries, documents, books, resources and cools stuffs about security. |
| [`BartoszJarocki/cv`](https://github.com/BartoszJarocki/cv) | ⭐9.7k |  | Print-friendly, minimalist CV page |
| [`linux-surface/linux-surface`](https://github.com/linux-surface/linux-surface) | ⭐7.3k |  | Linux Kernel for Surface Devices |
...
| [`trimstray/the-book-of-secret-knowledge`](https://github.com/trimstray/the-book-of-secret-knowledge) | ⭐225.9k | 💤 | A collection of inspiring lists, manuals, cheatsheets, blogs, hacks, one-liners, cli/web tools and more. |
...
| [`donlon/cloudflare-error-page`](https://github.com/donlon/cloudflare-error-page) | ⭐5.4k |  | ✅Browser ❌Cloudflare ✅Host — Generator of customized Cloudflare error pages (unofficial) |
...
| [`nvbn/thefuck`](https://github.com/nvbn/thefuck) | ⭐97.2k | 💤 | Magnificent app which corrects your previous console command. |
...
| [`AlynxZhou/gnome-shell-extension-inotch`](https://github.com/AlynxZhou/gnome-shell-extension-inotch) | ⭐936 | 💤 | Add a useless notch to your screen. |
| [`codenoid/github-roast`](https://github.com/codenoid/github-roast) | ⭐768 | 💤 | Spicy GitHub Roast 🔥 |
...
| [`glreno/oneko`](https://github.com/glreno/oneko) | ⭐242 | 💤 | The ever popular kitty-that-follows-your-mouse-pointer |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`gorhill/uBlock`](https://github.com/gorhill/uBlock) | ⭐65.1k | 🔥 | uBlock Origin - An efficient blocker for Chromium and Firefox. Fast and lean. |
| [`umami-software/umami`](https://github.com/umami-software/umami) | ⭐36.9k | 🔥 | Umami is a modern, privacy-focused analytics platform. An open-source alternative to Google Analytics, Mixp... |
| [`searxng/searxng`](https://github.com/searxng/searxng) | ⭐31.1k | 🔥 | SearXNG is a free internet metasearch engine which aggregates results from various search services and data... |
| [`pluja/awesome-privacy`](https://github.com/pluja/awesome-privacy) | ⭐18.8k | 🔥 | Awesome Privacy - A curated list of services and alternatives that respect your privacy because PRIVACY MAT... |
| [`simplex-chat/simplex-chat`](https://github.com/simplex-chat/simplex-chat) | ⭐11.2k | 🔥 | SimpleX - the first messaging network operating without user identifiers of any kind - 100% private by desi... |
...
| [`Anon-Planet/thgtoa`](https://github.com/Anon-Planet/thgtoa) | ⭐730 | 🔥 | The comprehensive guide for online anonymity and OpSec. |
| [`dani-garcia/vaultwarden`](https://github.com/dani-garcia/vaultwarden) | ⭐61.7k |  | Unofficial Bitwarden compatible server written in Rust, formerly known as bitwarden_rs |
| [`keeweb/keeweb`](https://github.com/keeweb/keeweb) | ⭐12.9k |  | Free cross-platform password manager compatible with KeePass |
| [`arkenfox/user.js`](https://github.com/arkenfox/user.js) | ⭐12.6k |  | Firefox privacy, security and anti-tracking: a comprehensive user.js template for configuration and hardening |
| [`mvt-project/mvt`](https://github.com/mvt-project/mvt) | ⭐12.5k |  | MVT (Mobile Verification Toolkit) helps with conducting forensics of mobile devices in order to find signs ... |
...
| [`peterhanania/Discord-Package`](https://github.com/peterhanania/Discord-Package) | ⭐547 |  | A detailed Discord data package explorer designed to help users visualize the data Discord collects. |
...
| [`rztprog/outlook-web-plus`](https://github.com/rztprog/outlook-web-plus) | ⭐3 |  | Remove ads and improve Outlook's web mailbox |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`9001/copyparty`](https://github.com/9001/copyparty) | ⭐45.1k | 🔥 | Portable file server with accelerated resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media in... |
| [`restic/restic`](https://github.com/restic/restic) | ⭐33.8k | 🔥 | Fast, secure, efficient backup program |
| [`mickael-kerjean/filestash`](https://github.com/mickael-kerjean/filestash) | ⭐14.3k | 🔥 | :file_folder: File Management Platform / Universal Data Access Layer (without FUSE) |
| [`databasus/databasus`](https://github.com/databasus/databasus) | ⭐7.0k | 🔥 | PostgreSQL backup tool with Point-In-Time-Recovery and restore verification |
| [`nicotsx/zerobyte`](https://github.com/nicotsx/zerobyte) | ⭐6.4k | 🔥 | Backup automation for self-hosters. Built on top of restic |
| [`trapexit/mergerfs`](https://github.com/trapexit/mergerfs) | ⭐5.7k | 🔥 | a featureful union filesystem |
| [`autobrr/qui`](https://github.com/autobrr/qui) | ⭐4.0k | 🔥 | A fast, single-binary qBittorrent web UI: manage multiple instances, automate torrent workflows, and cross-... |
...
| [`spacedriveapp/spacedrive`](https://github.com/spacedriveapp/spacedrive) | ⭐38.2k |  | Spacedrive is an open source cross-platform file explorer, powered by a virtual distributed filesystem writ... |
| [`arsenetar/dupeguru`](https://github.com/arsenetar/dupeguru) | ⭐7.6k |  | Find duplicate files |
| [`szabodanika/microbin`](https://github.com/szabodanika/microbin) | ⭐4.4k |  | A secure, configurable file-sharing and URL shortening web app written in Rust. |
| [`ServerContainers/samba`](https://github.com/ServerContainers/samba) | ⭐657 |  | samba - (ghcr.io/servercontainers/samba) (+ optional zeroconf, wsdd2 & time machine) on alpine [x86 + arm] |
| [`hurlenko/filebrowser-docker`](https://github.com/hurlenko/filebrowser-docker) | ⭐438 |  | 🐳 filebrowser inside Docker container |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`hydralauncher/hydra`](https://github.com/hydralauncher/hydra) | ⭐15.8k | 🔥 | Hydra Launcher is an open-source gaming platform created to be the single tool that you need |
...
| [`feldorn/free-games-claimer`](https://github.com/feldorn/free-games-claimer) | ⭐68 | 🔥 | Automatically claims free games and DLCs on the Epic Games Store, Steam, Amazon Prime Gaming and GOG. |
...
| [`TheOrcDev/warcraftcn-ui`](https://github.com/TheOrcDev/warcraftcn-ui) | ⭐743 |  | A collection of accessible, retro-inspired UI components drawing from classic real-time strategy aesthetics... |
...
| [`mackieks/Kawaii`](https://github.com/mackieks/Kawaii) | ⭐335 |  | Tiny, beautiful metal Wii keychain |
| [`mapcrafter/mapcrafter`](https://github.com/mapcrafter/mapcrafter) | ⭐638 | 💤 | High Performance Minecraft Map Renderer. |
| [`DeltaJordan/BotW-Save-Manager`](https://github.com/DeltaJordan/BotW-Save-Manager) | ⭐406 | 💤 | BOTW Save Manager for Switch and Wii U |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`Koenkk/zigbee2mqtt`](https://github.com/Koenkk/zigbee2mqtt) | ⭐15.2k | 🔥 | Zigbee 🐝 to MQTT bridge 🌉, get rid of your proprietary Zigbee bridges 🔨 |
| [`homeassistant-ai/ha-mcp`](https://github.com/homeassistant-ai/ha-mcp) | ⭐3.2k | 🔥 | The Unofficial and Awesome Home Assistant MCP Server |
| [`HGHugo/FreeboxOS-Ultra-Dashboard`](https://github.com/HGHugo/FreeboxOS-Ultra-Dashboard) | ⭐391 | 🔥 | Freebox OS Ultra Dashboard est une interface web moderne (React 19 + Express 5) pour piloter une Freebox : ... |
...
| [`CTalvio/Ultrachromic`](https://github.com/CTalvio/Ultrachromic) | ⭐956 |  | The final form, the true evolution of the chromic theme saga! |
| [`darkxst/silabs-firmware-builder`](https://github.com/darkxst/silabs-firmware-builder) | ⭐787 |  | Silicon Labs firmware builder |
| [`pvvx/ZigbeeTLc`](https://github.com/pvvx/ZigbeeTLc) | ⭐769 |  | Custom firmware for Zigbee 3.0 IoT devices on the TLSR825x chip |
| [`sbidy/pywizlight`](https://github.com/sbidy/pywizlight) | ⭐537 |  | A python connector for WiZ devices |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`junegunn/fzf`](https://github.com/junegunn/fzf) | ⭐80.7k | 🔥 | :cherry_blossom: A command-line fuzzy finder |
| [`sharkdp/bat`](https://github.com/sharkdp/bat) | ⭐59.1k | 🔥 | A cat(1) clone with wings. |
| [`sharkdp/fd`](https://github.com/sharkdp/fd) | ⭐43.2k | 🔥 | A simple, fast and user-friendly alternative to 'find' |
| [`chubin/wttr.in`](https://github.com/chubin/wttr.in) | ⭐29.8k | 🔥 | :partly_sunny: The right way to check the weather |
| [`fastfetch-cli/fastfetch`](https://github.com/fastfetch-cli/fastfetch) | ⭐23.0k | 🔥 | A maintained, feature-rich and performance oriented, neofetch like system information tool. |
| [`eza-community/eza`](https://github.com/eza-community/eza) | ⭐22.0k | 🔥 | A modern alternative to ls |
| [`topgrade-rs/topgrade`](https://github.com/topgrade-rs/topgrade) | ⭐4.1k | 🔥 | Upgrade all the things |
| [`koalaman/shellcheck`](https://github.com/koalaman/shellcheck) | ⭐39.5k |  | ShellCheck, a static analysis tool for shell scripts |
...
| [`romkatv/zsh-bench`](https://github.com/romkatv/zsh-bench) | ⭐971 |  | Benchmark for interactive Zsh |
...
| [`ddo/fast`](https://github.com/ddo/fast) | ⭐534 | 💤 | Minimal zero-dependency utility for testing your internet download speed from terminal |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`jesseduffield/lazygit`](https://github.com/jesseduffield/lazygit) | ⭐78.7k | 🔥 | simple terminal UI for git commands |
| [`sxyazi/yazi`](https://github.com/sxyazi/yazi) | ⭐38.9k | 🔥 | 💥 Blazing fast terminal file manager written in Rust, based on async I/O. |
| [`derailed/k9s`](https://github.com/derailed/k9s) | ⭐33.8k | 🔥 | 🐶 Kubernetes CLI To Manage Your Clusters In Style! |
| [`rothgar/awesome-tuis`](https://github.com/rothgar/awesome-tuis) | ⭐19.1k | 🔥 | List of projects that provide terminal user interfaces |
| [`jordond/jolt`](https://github.com/jordond/jolt) | ⭐504 | 🔥 | ⚡️A terminal-based battery and energy monitor for macOS and Linux. |
| [`Harry-kp/vortix`](https://github.com/Harry-kp/vortix) | ⭐425 | 🔥 | Terminal UI for WireGuard and OpenVPN with real-time telemetry and leak guarding. |
| [`jesseduffield/lazydocker`](https://github.com/jesseduffield/lazydocker) | ⭐51.2k |  | The lazier way to manage everything docker |
| [`pranshuparmar/witr`](https://github.com/pranshuparmar/witr) | ⭐17.6k |  | Why is this running? |
| [`muesli/duf`](https://github.com/muesli/duf) | ⭐15.1k |  | Disk Usage/Free Utility - a better 'df' alternative |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`anuraghazra/github-readme-stats`](https://github.com/anuraghazra/github-readme-stats) | ⭐79.6k | 🔥 | :zap: Dynamically generated stats for your github readmes |
| [`nektos/act`](https://github.com/nektos/act) | ⭐70.6k | 🔥 | Run your GitHub Actions locally 🚀 |
| [`lowlighter/metrics`](https://github.com/lowlighter/metrics) | ⭐16.7k | 🔥 | 📊 An infographics generator with 30+ plugins and 300+ options to display stats about your GitHub account an... |
| [`ahmedkhaleel2004/gitdiagram`](https://github.com/ahmedkhaleel2004/gitdiagram) | ⭐15.7k | 🔥 | Free, simple, fast interactive diagrams for any GitHub repository |
...
| [`jaedle/mirror-to-gitea`](https://github.com/jaedle/mirror-to-gitea) | ⭐227 | 🔥 | Mirror your github repositories to your gitea server |
...
| [`PatNei/GITHUB2FORGEJO`](https://github.com/PatNei/GITHUB2FORGEJO) | ⭐78 |  | Github 2 Forgejo: This script migrates your GitHub repositories to a Forgejo instance using the Forgejo API... |
...
| [`cmangos/mangos-wotlk`](https://github.com/cmangos/mangos-wotlk) | ⭐544 |  | C(ontinued)-MaNGOS is about: -- Doing WoW-Emulation Right! |
...
| [`mangostwo/database`](https://github.com/mangostwo/database) | ⭐56 |  | The Mangos TWO world database contains creatures, NPCs, Quests, Items/objects & gossip information to popul... |
| [`Shadez/wowarmory`](https://github.com/Shadez/wowarmory) | ⭐194 | 💤 | The World of Warcraft Armory is a vast searchable database of information for World of Warcraft - taken str... |
...
| [`portfolio-performance/portfolio`](https://github.com/portfolio-performance/portfolio) | ⭐3.9k | 🔥 | Track and evaluate the performance of your investment portfolio across stocks, cryptocurrencies, and other ... |
...
| [`tahnok/colmi_r02_client`](https://github.com/tahnok/colmi_r02_client) | ⭐621 |  | A python client + documentation for the Colmi R02 smart ring |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`Pumpkin-MC/Pumpkin`](https://github.com/Pumpkin-MC/Pumpkin) | ⭐7.7k | 🔥 | Empowering everyone to host fast and efficient Minecraft servers. |
...
| [`WindowsGSM/WindowsGSM`](https://github.com/WindowsGSM/WindowsGSM) | ⭐630 |  | 🎲 A powerful tool to manage game servers. Equipped with a GUI for server admins to install, import, start, ... |
| [`BohemiaInteractive/DayZ-Central-Economy`](https://github.com/BohemiaInteractive/DayZ-Central-Economy) | ⭐384 |  | DayZ Central Economy configuration |
| [`AsYetUntitled/Framework`](https://github.com/AsYetUntitled/Framework) | ⭐256 | 💤 | Altis Life RPG mission framework for Arma 3 originally made by @TAWTonic. |
...
| [`CookiePLMonster/SilentPatch`](https://github.com/CookiePLMonster/SilentPatch) | ⭐950 | 🔥 | SilentPatch for GTA III, Vice City, and San Andreas |
...
| [`FailedShack/USBHelperLauncher`](https://github.com/FailedShack/USBHelperLauncher) | ⭐505 | 💤 | USBHelperLauncher restores and enhances Wii U USB Helper functionality by patching it at runtime and interc... |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`shadps4-emu/shadPS4`](https://github.com/shadps4-emu/shadPS4) | ⭐31.2k | 🔥 | PlayStation 4 emulator for Windows, Linux, macOS and FreeBSD written in C++ |
| [`OpenRCT2/OpenRCT2`](https://github.com/OpenRCT2/OpenRCT2) | ⭐15.8k | 🔥 | An open source re-implementation of RollerCoaster Tycoon 2 🎢 |
| [`diasurgical/devilution`](https://github.com/diasurgical/devilution) | ⭐9.0k |  | Diablo devolved - magic behind the 1996 computer game |
| [`DaedalusX64/daedalus`](https://github.com/DaedalusX64/daedalus) | ⭐671 |  | The Nintendo 64 Emulator itself |
...
| [`gibbed/SteamAchievementManager`](https://github.com/gibbed/SteamAchievementManager) | ⭐8.4k |  | A manager for game achievements in Steam. |
...
| [`dyc3/steamguard-cli`](https://github.com/dyc3/steamguard-cli) | ⭐968 |  | A linux utility for generating 2FA codes for Steam and managing Steam trade, market, and other confirmations. |
...
<sub>Metadata last refreshed: 2026-06-01<br>🔥 hot: pushed in last 7 days<br>💤 stale: no push in 365+ days<br>📦 archived</sub>
<!-- STARS:END -->
