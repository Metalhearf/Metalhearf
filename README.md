...
| --- | --- | --- | --- |
| [`massgravel/Microsoft-Activation-Scripts`](https://github.com/massgravel/Microsoft-Activation-Scripts) | ⭐175.3k | 🔥 | Open-source Windows and Office activator featuring HWID, Ohook, TSforge, and Online KMS activation methods,... |
| [`ruvnet/RuView`](https://github.com/ruvnet/RuView) | ⭐56.5k | 🔥 | π RuView turns commodity WiFi signals into real-time spatial intelligence, vital sign monitoring, and prese... |
| [`trufflesecurity/trufflehog`](https://github.com/trufflesecurity/trufflehog) | ⭐26.3k | 🔥 | Find, verify, and analyze leaked credentials |
| [`usestrix/strix`](https://github.com/usestrix/strix) | ⭐25.3k | 🔥 | Open-source AI hackers to find and fix your app’s vulnerabilities. |
...
| [`six2dez/reconftw`](https://github.com/six2dez/reconftw) | ⭐7.6k | 🔥 | reconFTW is a tool designed to perform automated recon on a target domain by running the best set of tools ... |
...
| [`V4bel/dirtyfrag`](https://github.com/V4bel/dirtyfrag) | ⭐4.5k | 🔥 | _(no description)_ |
| [`KeygraphHQ/shannon`](https://github.com/KeygraphHQ/shannon) | ⭐42.0k |  | Shannon Lite is an autonomous, white-box AI pentester for web applications and APIs. It analyzes your sourc... |
...
| [`EmenstaNougat/ESP32-BlueJammer`](https://github.com/EmenstaNougat/ESP32-BlueJammer) | ⭐6.1k |  | The ESP32-BlueJammer (Bluetooth jammer, BLE jammer, WiFi jammer, RC jammer) disrupts 2.4GHz communications.... |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`n8n-io/n8n`](https://github.com/n8n-io/n8n) | ⭐187.9k | 🔥 | Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom cod... |
| [`excalidraw/excalidraw`](https://github.com/excalidraw/excalidraw) | ⭐123.3k | 🔥 | Virtual whiteboard for sketching hand-drawn like diagrams |
| [`Stirling-Tools/Stirling-PDF`](https://github.com/Stirling-Tools/Stirling-PDF) | ⭐78.8k | 🔥 | #1 PDF Application on GitHub that lets you edit PDFs on any device anywhere |
| [`toeverything/AFFiNE`](https://github.com/toeverything/AFFiNE) | ⭐68.4k | 🔥 | There can be more than Notion and Miro. AFFiNE(pronounced [ə‘fain]) is a next-gen knowledge base that bring... |
| [`siyuan-note/siyuan`](https://github.com/siyuan-note/siyuan) | ⭐43.9k | 🔥 | A privacy-first, self-hosted, fully open source personal knowledge management software, written in typescri... |
| [`logseq/logseq`](https://github.com/logseq/logseq) | ⭐42.9k | 🔥 | A privacy-first, open-source platform for knowledge management and collaboration. Download link:  http://gi... |
| [`calcom/cal.diy`](https://github.com/calcom/cal.diy) | ⭐42.5k | 🔥 | Scheduling infrastructure for absolutely everyone. |
| [`paperless-ngx/paperless-ngx`](https://github.com/paperless-ngx/paperless-ngx) | ⭐40.7k | 🔥 | A community-supported supercharged document management system: scan, index and archive all your documents |
| [`gethomepage/homepage`](https://github.com/gethomepage/homepage) | ⭐30.1k | 🔥 | A highly customizable homepage (or startpage / application dashboard) with Docker and service API integrati... |
| [`sipeed/picoclaw`](https://github.com/sipeed/picoclaw) | ⭐29.0k | 🔥 | Tiny, Fast, and Deployable anywhere — automate the mundane, unleash your creativity |
...
| [`alam00000/bentopdf`](https://github.com/alam00000/bentopdf) | ⭐13.3k | 🔥 | The Privacy First PDF Toolkit |
| [`mealie-recipes/mealie`](https://github.com/mealie-recipes/mealie) | ⭐12.2k | 🔥 | Mealie is a self hosted recipe manager and meal planner with a RestAPI backend and a reactive frontend appl... |
| [`Vinzent03/obsidian-git`](https://github.com/Vinzent03/obsidian-git) | ⭐10.9k | 🔥 | Integrate Git version control with automatic commit-and-sync and other advanced features in Obsidian.md |
...
| [`zensical/zensical`](https://github.com/zensical/zensical) | ⭐4.6k | 🔥 | A modern static site generator by the Material for MkDocs team |
...
| [`glanceapp/glance`](https://github.com/glanceapp/glance) | ⭐34.1k |  | A self-hosted dashboard that puts all your feeds in one place |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`ohmyzsh/ohmyzsh`](https://github.com/ohmyzsh/ohmyzsh) | ⭐187.0k | 🔥 | 🙃   A delightful community-driven (with 2,500+ contributors) framework for managing your zsh configuration.... |
| [`be5invis/Iosevka`](https://github.com/be5invis/Iosevka) | ⭐22.2k | 🔥 | Versatile typeface for code, from code. |
| [`HyDE-Project/HyDE`](https://github.com/HyDE-Project/HyDE) | ⭐9.0k | 🔥 | HyDE, your Development Environment 🖥️💻 |
...
| [`catppuccin/vscode-icons`](https://github.com/catppuccin/vscode-icons) | ⭐979 | 🔥 | 🦊 Soothing pastel icons for VSCode/VSCodium |
| [`rubiin/tsumiki`](https://github.com/rubiin/tsumiki) | ⭐233 | 🔥 | modular panel written on fabric |
| [`romkatv/powerlevel10k`](https://github.com/romkatv/powerlevel10k) | ⭐54.2k |  | A Zsh theme |
...
| [`Stunkymonkey/nautilus-open-any-terminal`](https://github.com/Stunkymonkey/nautilus-open-any-terminal) | ⭐937 |  | _(no description)_ |
| [`catppuccin/cursors`](https://github.com/catppuccin/cursors) | ⭐717 |  | 🐁 Soothing pastel cursors for GTK/Plasma/Hyprland |
...
| [`zhichaoh/catppuccin-wallpapers`](https://github.com/zhichaoh/catppuccin-wallpapers) | ⭐846 | 💤 | 🖼️ Wallpapers to match your Catppuccin setups! |
| [`nickclyde/rofi-bluetooth`](https://github.com/nickclyde/rofi-bluetooth) | ⭐601 | 💤 | 🔷 A script that generates a rofi menu that uses bluetoothctl to connect to bluetooth devices and display st... |
...
| [`dockur/windows`](https://github.com/dockur/windows) | ⭐51.4k | 🔥 | Windows inside a Docker container. |
| [`Dokploy/dokploy`](https://github.com/Dokploy/dokploy) | ⭐34.0k | 🔥 | Open Source Alternative to Vercel, Netlify and Heroku. |
...
| [`Mafyuh/iac`](https://github.com/Mafyuh/iac) | ⭐473 | 🔥 | GitOps-driven Infrastructure as Code for my homelab |
...
| [`Codycody31/Prevent-OCI-Deletion-for-being-idle`](https://github.com/Codycody31/Prevent-OCI-Deletion-for-being-idle) | ⭐37 | 💤 | Scripts to maintain active OCI ForeverFree tier instances, preventing deletions due to inactivity. |
...
| [`gitroomhq/postiz-app`](https://github.com/gitroomhq/postiz-app) | ⭐30.4k | 🔥 | 📨 The ultimate agentic social media scheduling tool 🤖 |
| [`chatwoot/chatwoot`](https://github.com/chatwoot/chatwoot) | ⭐29.2k | 🔥 | Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Se... |
...
| [`processone/fluux-messenger`](https://github.com/processone/fluux-messenger) | ⭐343 | 🔥 | Fluux Messenger: A fast, modern, cross-platform XMPP client for communities and organizations. |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`awesome-selfhosted/awesome-selfhosted`](https://github.com/awesome-selfhosted/awesome-selfhosted) | ⭐292.3k | 🔥 | A list of Free Software network services and web applications which can be hosted on your own servers |
| [`danielmiessler/SecLists`](https://github.com/danielmiessler/SecLists) | ⭐70.9k | 🔥 | SecLists is the security tester's companion. It's a collection of multiple types of lists used during secur... |
...
| [`codecrafters-io/build-your-own-x`](https://github.com/codecrafters-io/build-your-own-x) | ⭐501.5k |  | Master programming by recreating your favorite technologies from scratch. |
| [`donnemartin/system-design-primer`](https://github.com/donnemartin/system-design-primer) | ⭐348.6k |  | Learn how to design large-scale systems. Prep for the system design interview.  Includes Anki flashcards. |
| [`jwasham/coding-interview-university`](https://github.com/jwasham/coding-interview-university) | ⭐346.8k |  | A complete computer science study plan to become a software engineer. |
| [`twitter/the-algorithm`](https://github.com/twitter/the-algorithm) | ⭐73.1k |  | Source code for the X Recommendation Algorithm |
| [`imthenachoman/How-To-Secure-A-Linux-Server`](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) | ⭐27.3k |  | An evolving how-to guide for securing a Linux server. |
...
| [`dev-sec/linux-baseline`](https://github.com/dev-sec/linux-baseline) | ⭐868 |  | DevSec Linux Baseline - InSpec Profile |
...
| [`trimstray/the-book-of-secret-knowledge`](https://github.com/trimstray/the-book-of-secret-knowledge) | ⭐220.3k | 💤 | A collection of inspiring lists, manuals, cheatsheets, blogs, hacks, one-liners, cli/web tools and more. |
...
| [`nvbn/thefuck`](https://github.com/nvbn/thefuck) | ⭐97.0k | 💤 | Magnificent app which corrects your previous console command. |
...
| [`codenoid/github-roast`](https://github.com/codenoid/github-roast) | ⭐769 | 💤 | Spicy GitHub Roast 🔥 |
...
| [`glreno/oneko`](https://github.com/glreno/oneko) | ⭐239 | 💤 | The ever popular kitty-that-follows-your-mouse-pointer |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`sherlock-project/sherlock`](https://github.com/sherlock-project/sherlock) | ⭐83.3k | 🔥 | Hunt down social media accounts by username across social networks |
| [`lissy93/web-check`](https://github.com/lissy93/web-check) | ⭐33.1k | 🔥 | 🕵️‍♂️ All-in-one OSINT tool for analysing any website |
| [`soxoj/maigret`](https://github.com/soxoj/maigret) | ⭐28.7k | 🔥 | 🕵️‍♂️ Collect a dossier on a person by username from 3000+ sites |
...
| [`l4rm4nd/LinkedInDumper`](https://github.com/l4rm4nd/LinkedInDumper) | ⭐589 |  | Python 3 script to dump/scrape/extract company employees from LinkedIn API |
| [`megadose/holehe`](https://github.com/megadose/holehe) | ⭐10.9k | 💤 | holehe allows you to check if the mail is used on different sites like twitter, instagram and will retrieve... |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`traefik/traefik`](https://github.com/traefik/traefik) | ⭐63.2k | 🔥 | The Cloud Native Application Proxy |
| [`pi-hole/pi-hole`](https://github.com/pi-hole/pi-hole) | ⭐58.6k | 🔥 | A black hole for Internet advertisements |
| [`juanfont/headscale`](https://github.com/juanfont/headscale) | ⭐38.4k | 🔥 | An open source, self-hosted implementation of the Tailscale control server |
| [`openwrt/openwrt`](https://github.com/openwrt/openwrt) | ⭐26.9k | 🔥 | This repository is a mirror of https://git.openwrt.org/openwrt/openwrt.git It is for reference only and is ... |
| [`wg-easy/wg-easy`](https://github.com/wg-easy/wg-easy) | ⭐25.7k | 🔥 | The easiest way to run WireGuard VPN + Web-based Admin UI. |
| [`netbirdio/netbird`](https://github.com/netbirdio/netbird) | ⭐25.2k | 🔥 | Connect your devices into a secure WireGuard®-based overlay network with SSO, MFA and granular access contr... |
| [`fosrl/pangolin`](https://github.com/fosrl/pangolin) | ⭐20.8k | 🔥 | Identity-aware VPN and tunneled reverse proxy for remote access based on WireGuard®. |
| [`nginx-proxy/nginx-proxy`](https://github.com/nginx-proxy/nginx-proxy) | ⭐19.8k | 🔥 | Automated Nginx Reverse Proxy for Docker |
| [`TecharoHQ/anubis`](https://github.com/TecharoHQ/anubis) | ⭐19.3k | 🔥 | Weighs the soul of incoming HTTP requests to stop AI crawlers |
...
| [`proxifly/free-proxy-list`](https://github.com/proxifly/free-proxy-list) | ⭐5.2k | 🔥 | 🚀 Free HTTP, SOCKS4, & SOCKS5 Proxy List * Updated every 5 minutes * |
...
| [`WaLLy3K/wally3k.github.io`](https://github.com/WaLLy3K/wally3k.github.io) | ⭐902 |  | Repo for Firebog hosting |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`gorhill/uBlock`](https://github.com/gorhill/uBlock) | ⭐64.7k | 🔥 | uBlock Origin - An efficient blocker for Chromium and Firefox. Fast and lean. |
| [`umami-software/umami`](https://github.com/umami-software/umami) | ⭐36.7k | 🔥 | Umami is a modern, privacy-focused analytics platform. An open-source alternative to Google Analytics, Mixp... |
| [`searxng/searxng`](https://github.com/searxng/searxng) | ⭐30.0k | 🔥 | SearXNG is a free internet metasearch engine which aggregates results from various search services and data... |
...
| [`dani-garcia/vaultwarden`](https://github.com/dani-garcia/vaultwarden) | ⭐60.3k |  | Unofficial Bitwarden compatible server written in Rust, formerly known as bitwarden_rs |
...
| [`peterhanania/Discord-Package`](https://github.com/peterhanania/Discord-Package) | ⭐545 |  | A detailed Discord data package explorer designed to help users visualize the data Discord collects. |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`9001/copyparty`](https://github.com/9001/copyparty) | ⭐44.8k | 🔥 | Portable file server with accelerated resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media in... |
| [`restic/restic`](https://github.com/restic/restic) | ⭐33.5k | 🔥 | Fast, secure, efficient backup program |
| [`mickael-kerjean/filestash`](https://github.com/mickael-kerjean/filestash) | ⭐14.2k | 🔥 | :file_folder: File Management Platform / Universal Data Access Layer (without FUSE) |
| [`databasus/databasus`](https://github.com/databasus/databasus) | ⭐6.9k | 🔥 | Database backup tool (PostgreSQL, MySQL\MariaDB and MongoDB) |
...
| [`autobrr/qui`](https://github.com/autobrr/qui) | ⭐3.9k | 🔥 | A fast, single-binary qBittorrent web UI: manage multiple instances, automate torrent workflows, and cross-... |
...
| [`ServerContainers/samba`](https://github.com/ServerContainers/samba) | ⭐651 |  | samba - (ghcr.io/servercontainers/samba) (+ optional zeroconf, wsdd2 & time machine) on alpine [x86 + arm] |
| [`hurlenko/filebrowser-docker`](https://github.com/hurlenko/filebrowser-docker) | ⭐439 |  | 🐳 filebrowser inside Docker container |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`Genymobile/scrcpy`](https://github.com/Genymobile/scrcpy) | ⭐141.5k | 🔥 | Display and control your Android device |
| [`yuliskov/SmartTube`](https://github.com/yuliskov/SmartTube) | ⭐30.1k | 🔥 | Browse media content with your own rules on Android TV |
| [`ReVanced/revanced-manager`](https://github.com/ReVanced/revanced-manager) | ⭐27.9k | 🔥 | 💊 Application to use ReVanced on Android |
| [`offa/android-foss`](https://github.com/offa/android-foss) | ⭐10.1k | 🔥 | A list of Free and Open Source Software (FOSS) for Android – saving Freedom and Privacy. |
| [`breezy-weather/breezy-weather`](https://github.com/breezy-weather/breezy-weather) | ⭐10.1k | 🔥 | A feature-rich weather app with good visualizations and more than 50 sources. |
| [`Universal-Debloater-Alliance/universal-android-debloater-next-generation`](https://github.com/Universal-Debloater-Alliance/universal-android-debloater-next-generation) | ⭐6.6k | 🔥 | Cross-platform GUI written in Rust using ADB to debloat non-rooted Android devices. Improve your privacy, t... |
| [`MorpheApp/morphe-manager`](https://github.com/MorpheApp/morphe-manager) | ⭐4.9k | 🔥 | Morphe app patcher for Android |
| [`MorpheApp/morphe-patches`](https://github.com/MorpheApp/morphe-patches) | ⭐2.1k | 🔥 | Morphe Patches |
| [`Arcticons-Team/Arcticons`](https://github.com/Arcticons-Team/Arcticons) | ⭐1.5k | 🔥 | A monotone line-based icon pack for android |
| [`bryanroscoe/shield_optimizer`](https://github.com/bryanroscoe/shield_optimizer) | ⭐599 | 🔥 | _(no description)_ |
| [`topjohnwu/Magisk`](https://github.com/topjohnwu/Magisk) | ⭐60.4k |  | The Magic Mask for Android |
...
| [`corentin-c/SpotifyAutoPatcher`](https://github.com/corentin-c/SpotifyAutoPatcher) | ⭐442 |  | The easiest way to patch Spotify and Youtube Music, without the need to download APKs ! |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`louislam/uptime-kuma`](https://github.com/louislam/uptime-kuma) | ⭐86.8k | 🔥 | A fancy self-hosted monitoring tool |
| [`netdata/netdata`](https://github.com/netdata/netdata) | ⭐78.8k | 🔥 | The fastest path to AI-powered full stack observability, even for lean teams. |
| [`dgtlmoon/changedetection.io`](https://github.com/dgtlmoon/changedetection.io) | ⭐31.5k | 🔥 | Best and simplest tool for website change detection, web page monitoring, and website change alerts. Perfec... |
| [`grafana/loki`](https://github.com/grafana/loki) | ⭐28.2k | 🔥 | Like Prometheus, but for logs. |
| [`henrygd/beszel`](https://github.com/henrygd/beszel) | ⭐21.9k | 🔥 | Lightweight server monitoring with historical data, docker stats, and alerts. |
| [`openobserve/openobserve`](https://github.com/openobserve/openobserve) | ⭐18.9k | 🔥 | Open source observability platform for logs, metrics, traces, frontend monitoring, pipelines and LLM observ... |
...
| [`autobrr/netronome`](https://github.com/autobrr/netronome) | ⭐908 |  | Netronome is a modern network speed testing and monitoring tool built with Go and React. |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`LadybirdBrowser/ladybird`](https://github.com/LadybirdBrowser/ladybird) | ⭐63.4k | 🔥 | Truly independent web browser |
| [`ghostty-org/ghostty`](https://github.com/ghostty-org/ghostty) | ⭐54.6k | 🔥 | 👻 Ghostty is a fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GP... |
| [`tw93/Mole`](https://github.com/tw93/Mole) | ⭐51.4k | 🔥 | 🐹 Deep clean and optimize your Mac. |
| [`microsoft/WSL`](https://github.com/microsoft/WSL) | ⭐32.3k | 🔥 | Windows Subsystem for Linux |
| [`Devolutions/UniGetUI`](https://github.com/Devolutions/UniGetUI) | ⭐23.8k | 🔥 | UniGetUI: The Graphical Interface for your package managers. Could be terribly described as a package manag... |
| [`beekeeper-studio/beekeeper-studio`](https://github.com/beekeeper-studio/beekeeper-studio) | ⭐22.8k | 🔥 | Modern and easy to use SQL client for MySQL, Postgres, SQLite, SQL Server, and more. Linux, MacOS, and Wind... |
| [`m1k1o/neko`](https://github.com/m1k1o/neko) | ⭐20.9k | 🔥 | A self hosted virtual browser that runs in docker and uses WebRTC. |
| [`ventoy/Ventoy`](https://github.com/ventoy/Ventoy) | ⭐76.6k |  | A new bootable USB solution. |
| [`Klocman/Bulk-Crap-Uninstaller`](https://github.com/Klocman/Bulk-Crap-Uninstaller) | ⭐19.1k |  | Remove large amounts of unwanted applications quickly. |
| [`originalankur/maptoposter`](https://github.com/originalankur/maptoposter) | ⭐13.2k |  | Transform your favorite cities into beautiful, minimalist designs. MapToPoster lets you create and export v... |
...
| [`zerebos/ghostty-config`](https://github.com/zerebos/ghostty-config) | ⭐3.7k |  | A beautiful config generator for Ghostty terminal. |
...
| [`MetrolistGroup/Metrolist`](https://github.com/MetrolistGroup/Metrolist) | ⭐9.3k | 🔥 | YouTube Music client for Android |
...
| [`spotiflacapp/SpotiFLAC-Mobile`](https://github.com/spotiflacapp/SpotiFLAC-Mobile) | ⭐4.2k | 🔥 | Mobile music utility built with Flutter and Go. High-quality audio management for your personal library. - ... |
| [`KRTirtho/spotube`](https://github.com/KRTirtho/spotube) | ⭐46.2k |  | 🎧 Open source music streaming app! Available for both desktop & mobile! |
| [`spicetify/cli`](https://github.com/spicetify/cli) | ⭐23.1k |  | Command-line tool to customize Spotify client. Supports Windows, macOS, and Linux. |
| [`spotbye/SpotiFLAC`](https://github.com/spotbye/SpotiFLAC) | ⭐8.4k |  | Get Spotify tracks in true FLAC from Tidal, Qobuz & Amazon Music — no account required. |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`junegunn/fzf`](https://github.com/junegunn/fzf) | ⭐80.3k | 🔥 | :cherry_blossom: A command-line fuzzy finder |
| [`sharkdp/bat`](https://github.com/sharkdp/bat) | ⭐58.9k | 🔥 | A cat(1) clone with wings. |
| [`chubin/wttr.in`](https://github.com/chubin/wttr.in) | ⭐29.6k | 🔥 | :partly_sunny: The right way to check the weather |
| [`fastfetch-cli/fastfetch`](https://github.com/fastfetch-cli/fastfetch) | ⭐22.7k | 🔥 | A maintained, feature-rich and performance oriented, neofetch like system information tool. |
| [`topgrade-rs/topgrade`](https://github.com/topgrade-rs/topgrade) | ⭐4.0k | 🔥 | Upgrade all the things |
| [`sharkdp/fd`](https://github.com/sharkdp/fd) | ⭐43.0k |  | A simple, fast and user-friendly alternative to 'find' |
| [`koalaman/shellcheck`](https://github.com/koalaman/shellcheck) | ⭐39.4k |  | ShellCheck, a static analysis tool for shell scripts |
| [`eza-community/eza`](https://github.com/eza-community/eza) | ⭐21.8k |  | A modern alternative to ls |
...
| [`romkatv/zsh-bench`](https://github.com/romkatv/zsh-bench) | ⭐965 |  | Benchmark for interactive Zsh |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`jesseduffield/lazygit`](https://github.com/jesseduffield/lazygit) | ⭐78.0k | 🔥 | simple terminal UI for git commands |
| [`sxyazi/yazi`](https://github.com/sxyazi/yazi) | ⭐38.1k | 🔥 | 💥 Blazing fast terminal file manager written in Rust, based on async I/O. |
| [`derailed/k9s`](https://github.com/derailed/k9s) | ⭐33.6k | 🔥 | 🐶 Kubernetes CLI To Manage Your Clusters In Style! |
| [`rothgar/awesome-tuis`](https://github.com/rothgar/awesome-tuis) | ⭐18.9k | 🔥 | List of projects that provide terminal user interfaces |
| [`pranshuparmar/witr`](https://github.com/pranshuparmar/witr) | ⭐16.1k | 🔥 | Why is this running? |
| [`jordond/jolt`](https://github.com/jordond/jolt) | ⭐498 | 🔥 | ⚡️A terminal-based battery and energy monitor for macOS and Linux. |
| [`Harry-kp/vortix`](https://github.com/Harry-kp/vortix) | ⭐418 | 🔥 | Terminal UI for WireGuard and OpenVPN with real-time telemetry and leak guarding. |
| [`jesseduffield/lazydocker`](https://github.com/jesseduffield/lazydocker) | ⭐51.0k |  | The lazier way to manage everything docker |
...
| [`0xhckr/ghostty-shaders`](https://github.com/0xhckr/ghostty-shaders) | ⭐1.3k |  | A repository containing many free shaders to use with ghostty (the terminal) |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`nektos/act`](https://github.com/nektos/act) | ⭐70.3k | 🔥 | Run your GitHub Actions locally 🚀 |
...
| [`anuraghazra/github-readme-stats`](https://github.com/anuraghazra/github-readme-stats) | ⭐79.4k |  | :zap: Dynamically generated stats for your github readmes |
...
| [`PatNei/GITHUB2FORGEJO`](https://github.com/PatNei/GITHUB2FORGEJO) | ⭐74 |  | Github 2 Forgejo: This script migrates your GitHub repositories to a Forgejo instance using the Forgejo API... |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`cmangos/mangos-wotlk`](https://github.com/cmangos/mangos-wotlk) | ⭐542 | 🔥 | C(ontinued)-MaNGOS is about: -- Doing WoW-Emulation Right! |
| [`balakethelock/SuperWoW`](https://github.com/balakethelock/SuperWoW) | ⭐158 | 🔥 | 1.12.1 WoW client mod that expands on API functionalities |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`we-promise/sure`](https://github.com/we-promise/sure) | ⭐8.2k | 🔥 | The personal finance app for everyone (by everyone) |
| [`mauriceboe/TREK`](https://github.com/mauriceboe/TREK) | ⭐4.9k | 🔥 | A self-hosted travel/trip planner with real-time collaboration, interactive maps, PWA support, SSO, budgets... |
...
| [`tahnok/colmi_r02_client`](https://github.com/tahnok/colmi_r02_client) | ⭐617 |  | A python client + documentation for the Colmi R02 smart ring |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`Pumpkin-MC/Pumpkin`](https://github.com/Pumpkin-MC/Pumpkin) | ⭐7.6k | 🔥 | Empowering everyone to host fast and efficient Minecraft servers. |
...
| [`WindowsGSM/WindowsGSM`](https://github.com/WindowsGSM/WindowsGSM) | ⭐627 |  | 🎲 A powerful tool to manage game servers. Equipped with a GUI for server admins to install, import, start, ... |
| [`BohemiaInteractive/DayZ-Central-Economy`](https://github.com/BohemiaInteractive/DayZ-Central-Economy) | ⭐381 |  | DayZ Central Economy configuration |
| [`AsYetUntitled/Framework`](https://github.com/AsYetUntitled/Framework) | ⭐255 | 💤 | Altis Life RPG mission framework for Arma 3 originally made by @TAWTonic. |
...
| [`CookiePLMonster/SilentPatch`](https://github.com/CookiePLMonster/SilentPatch) | ⭐931 | 🔥 | SilentPatch for GTA III, Vice City, and San Andreas |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`shadps4-emu/shadPS4`](https://github.com/shadps4-emu/shadPS4) | ⭐31.1k | 🔥 | PlayStation 4 emulator for Windows, Linux, macOS and FreeBSD written in C++ |
...
| [`DaedalusX64/daedalus`](https://github.com/DaedalusX64/daedalus) | ⭐670 |  | The Nintendo 64 Emulator itself |
...
| [`dyc3/steamguard-cli`](https://github.com/dyc3/steamguard-cli) | ⭐959 | 🔥 | A linux utility for generating 2FA codes for Steam and managing Steam trade, market, and other confirmations. |
...
<sub>Metadata last refreshed: 2026-05-15<br>🔥 hot: pushed in last 7 days<br>💤 stale: no push in 365+ days<br>📦 archived</sub>
<!-- STARS:END -->
