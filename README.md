...
**457 repos** across **29 categories**. Click any section to expand.
...
| --- | --- | --- | --- |
| [`massgravel/Microsoft-Activation-Scripts`](https://github.com/massgravel/Microsoft-Activation-Scripts) | ⭐174.5k | 🔥 | Open-source Windows and Office activator featuring HWID, Ohook, TSforge, and Online KMS activation methods,... |
| [`ruvnet/RuView`](https://github.com/ruvnet/RuView) | ⭐52.0k | 🔥 | π RuView turns commodity WiFi signals into real-time spatial intelligence, vital sign monitoring, and prese... |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`n8n-io/n8n`](https://github.com/n8n-io/n8n) | ⭐187.0k | 🔥 | Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom cod... |
| [`excalidraw/excalidraw`](https://github.com/excalidraw/excalidraw) | ⭐122.7k | 🔥 | Virtual whiteboard for sketching hand-drawn like diagrams |
...
| [`toeverything/AFFiNE`](https://github.com/toeverything/AFFiNE) | ⭐68.1k | 🔥 | There can be more than Notion and Miro. AFFiNE(pronounced [ə‘fain]) is a next-gen knowledge base that bring... |
...
| [`mult1v4c/hestia-core`](https://github.com/mult1v4c/hestia-core) | ⭐673 |  | A grid-based, modular dashboard built entirely from HTML, CSS, and JS with the ability to create your custo... |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`yt-dlp/yt-dlp`](https://github.com/yt-dlp/yt-dlp) | ⭐161.0k | 🔥 | A feature-rich command-line audio/video downloader |
...
| [`immich-app/immich`](https://github.com/immich-app/immich) | ⭐99.9k | 🔥 | High performance self-hosted photo and video management solution. |
...
| [`Salvoxia/immich-folder-album-creator`](https://github.com/Salvoxia/immich-folder-album-creator) | ⭐996 |  | Automatically create and populate albums in Immich from a folder structure in external libraries |
...
| [`zhichaoh/catppuccin-wallpapers`](https://github.com/zhichaoh/catppuccin-wallpapers) | ⭐840 | 💤 | 🖼️ Wallpapers to match your Catppuccin setups! |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`awesome-selfhosted/awesome-selfhosted`](https://github.com/awesome-selfhosted/awesome-selfhosted) | ⭐290.9k | 🔥 | A list of Free Software network services and web applications which can be hosted on your own servers |
...
| [`codecrafters-io/build-your-own-x`](https://github.com/codecrafters-io/build-your-own-x) | ⭐499.8k |  | Master programming by recreating your favorite technologies from scratch. |
| [`donnemartin/system-design-primer`](https://github.com/donnemartin/system-design-primer) | ⭐347.4k |  | Learn how to design large-scale systems. Prep for the system design interview.  Includes Anki flashcards. |
...
| [`trimstray/the-book-of-secret-knowledge`](https://github.com/trimstray/the-book-of-secret-knowledge) | ⭐219.2k | 💤 | A collection of inspiring lists, manuals, cheatsheets, blogs, hacks, one-liners, cli/web tools and more. |
...
| [`gitroomhq/postiz-app`](https://github.com/gitroomhq/postiz-app) | ⭐30.1k | 🔥 | 📨 The ultimate agentic social media scheduling tool 🤖 |
...
| [`goharbor/harbor`](https://github.com/goharbor/harbor) | ⭐28.4k | 🔥 | An open source trusted cloud native registry project that stores, signs, and scans content. |
...
| [`soxoj/maigret`](https://github.com/soxoj/maigret) | ⭐26.3k | 🔥 | 🕵️‍♂️ Collect a dossier on a person by username from 3000+ sites |
...
| [`bryanroscoe/shield_optimizer`](https://github.com/bryanroscoe/shield_optimizer) | ⭐589 |  | _(no description)_ |
| [`corentin-c/SpotifyAutoPatcher`](https://github.com/corentin-c/SpotifyAutoPatcher) | ⭐419 |  | The easiest way to patch Spotify and Youtube Music, without the need to download APKs ! |
...
| [`autobrr/netronome`](https://github.com/autobrr/netronome) | ⭐904 | 🔥 | Netronome is a modern network speed testing and monitoring tool built with Go and React. |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`dani-garcia/vaultwarden`](https://github.com/dani-garcia/vaultwarden) | ⭐59.9k | 🔥 | Unofficial Bitwarden compatible server written in Rust, formerly known as bitwarden_rs |
...
| [`searxng/searxng`](https://github.com/searxng/searxng) | ⭐29.6k | 🔥 | SearXNG is a free internet metasearch engine which aggregates results from various search services and data... |
...
| [`TheOrcDev/warcraftcn-ui`](https://github.com/TheOrcDev/warcraftcn-ui) | ⭐734 |  | A collection of accessible, retro-inspired UI components drawing from classic real-time strategy aesthetics... |
...
| [`mackieks/Kawaii`](https://github.com/mackieks/Kawaii) | ⭐314 |  | Tiny, beautiful metal Wii keychain |
...
| [`ghostty-org/ghostty`](https://github.com/ghostty-org/ghostty) | ⭐53.8k | 🔥 | 👻 Ghostty is a fast, feature-rich, and cross-platform terminal emulator that uses platform-native UI and GP... |
| [`tw93/Mole`](https://github.com/tw93/Mole) | ⭐50.4k | 🔥 | 🐹 Deep clean and optimize your Mac. |
...
| [`CTalvio/Ultrachromic`](https://github.com/CTalvio/Ultrachromic) | ⭐945 |  | The final form, the true evolution of the chromic theme saga! |
...
| [`HGHugo/FreeboxOS-Ultra-Dashboard`](https://github.com/HGHugo/FreeboxOS-Ultra-Dashboard) | ⭐389 |  | Freebox OS Ultra Dashboard est une interface web moderne (React 19 + Express 5) pour piloter une Freebox : ... |
...
<details>
<summary><b>AI</b> &nbsp;·&nbsp; 13 ⭐ &nbsp;·&nbsp; <i>Local LLMs, AI coding agents, TTS engines and AI-augmented productivity tools.</i></summary>

| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`openclaw/openclaw`](https://github.com/openclaw/openclaw) | ⭐369.6k | 🔥 | Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 |
| [`anomalyco/opencode`](https://github.com/anomalyco/opencode) | ⭐156.7k | 🔥 | The open source coding agent. |
| [`open-webui/open-webui`](https://github.com/open-webui/open-webui) | ⭐136.0k | 🔥 | User-friendly AI Interface (Supports Ollama, OpenAI API, ...) |
| [`punkpeye/awesome-mcp-servers`](https://github.com/punkpeye/awesome-mcp-servers) | ⭐86.5k | 🔥 | A collection of MCP servers. |
| [`santifer/career-ops`](https://github.com/santifer/career-ops) | ⭐43.4k | 🔥 | AI-powered job search system built on Claude Code. 14 skill modes, Go dashboard, PDF generation, batch proc... |
...
| [`forrestchang/andrej-karpathy-skills`](https://github.com/forrestchang/andrej-karpathy-skills) | ⭐119.3k |  | A single CLAUDE.md file to improve Claude Code behavior, derived from Andrej Karpathy's observations on LLM... |
| [`OpenBMB/VoxCPM`](https://github.com/OpenBMB/VoxCPM) | ⭐17.6k |  | VoxCPM2: Tokenizer-Free TTS for Multilingual Speech Generation, Creative Voice Design, and True-to-Life Clo... |
...
| [`romkatv/zsh-bench`](https://github.com/romkatv/zsh-bench) | ⭐961 |  | Benchmark for interactive Zsh |
...
| Repo | Stars | Status | Description |
| --- | --- | --- | --- |
| [`jesseduffield/lazygit`](https://github.com/jesseduffield/lazygit) | ⭐77.6k | 🔥 | simple terminal UI for git commands |
...
| [`dyc3/steamguard-cli`](https://github.com/dyc3/steamguard-cli) | ⭐955 |  | A linux utility for generating 2FA codes for Steam and managing Steam trade, market, and other confirmations. |
...
<sub>Last updated: 2026-05-08<br>🔥 hot: pushed in last 7 days<br>💤 stale: no push in 365+ days<br>📦 archived</sub>
<!-- STARS:END -->
